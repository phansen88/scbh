...
const NavbarBottom = () => {
  return (
    <section
      ...
      className="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-lash-pink-600 shadow"
    >
      <div id="tabs" className="flex justify-between">
        <a
          href="/"
          className="w-full text-lash-pink-50/95 focus:text-lash-pink-200 hover:text-lash-pink-300/90 justify-center inline-block text-center pt-2 pb-1"
        >
          <svg
