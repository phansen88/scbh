            ...
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div className="col-span-1">
                <div className="flex flex-row flex-wrap justify-center">
                  <Image
                    className="object-cover w-full h-full mx-auto rounded-md lg:max-w-sm lg:mx-0 mt-6 md:mt-0"
                    width={100}
                    height={100}
                    quality={90}
                    src="/logo.svg"
                  ...
                  <h1 className="font-playfair text-2xl md:text-5xl text-lash-pink-400 mt-2 md:mt-8">
                    Få din <span className="text-lash-pink-800">skønhed</span>{' '}
                    til at blomstre
                  </h1>
                </div>
              </div>
              ...
              <div className="col-span-1">
                <div className="relative mb-12 lg:mb-0 lg:flex lg:flex-col lg:justify-self-end">
                  <div className="relative block rounded-lg px-0 pt-6 pb-4 md:px-12 lg:col-start-2">
